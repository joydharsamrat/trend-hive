        ...
        {cartItems?.data.data.length > 0 ? (
          <div>
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    disabled={
                      isUpdating === item._id || isRemoving === item._id
                    }
                  >
                    -
                  </button>
            ...
            <div className="flex justify-between items-center mt-8">
              ...
              <Link
                href="/user/checkout"
                className="bg-primary-700 text-white font-semibold py-3 px-8 rounded-md hover:bg-primary-500 transition duration-300"
              >
                Proceed to Checkout
              </Link>
            </div>
